...
part:
  ...
  jlcpcb/micromouse-pcb-simplified-2layer-jlcpcb-gerbers.zip  fab (Gerber X2 + Excellon)
...
def main():
    ...
    for f in ("bom_jlcpcb.csv", "cpl_jlcpcb.csv", "micromouse-pcb-simplified-jlcpcb.zip",
    ...
    zpath = os.path.join(OUT, "micromouse-pcb-simplified-2layer-jlcpcb-gerbers.zip")
    ...
    jlc_pos_path = os.path.join(FAB, "micromouse-pcb-simplified.jlc-positions.csv")
