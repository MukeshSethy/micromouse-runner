...
| MMSE-PWR-5 | Input protection: reverse-polarity + over-current. | R | M | A | VERIFIED | F1 MINISMDC260F/16-2 (2.6 A hold / 5.0 A trip, 16 V PPTC — corrected from a stale/non-orderable part number, confirmed in stock at LCSC C16490) + Q1 DMP3098L reverse P-FET (Vgs ±20 V, 2S-safe). |
